...
//
// **这不是"让 collector 全局走系统代理"的理由,恰恰相反。** docs/features/12 章记着一组
...
//
// 探活(proxyReachable)不能省。代理软件崩溃/被强杀时,macOS 那份系统代理开关会**留在
...
// 的那一个。
//
// 返回的 scheme 是 **http** 而不是 https。那两个字段名说的是"给哪种流量用",不是"用什么
