...
// YouTube Music 网页播放的「这是广告还是一首歌」判据。
//
// ## 为什么需要它
//
...
// 页面 DOM。同一批成对采样里,**22 个连续样本、横跨两条不同广告**:
//
//	                        广告期间        真歌期间
