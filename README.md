...
- **Nine lyrics sources checked automatically** — NetEase Cloud Music, QQ Music, Kugou, Kuwo, Migu, Musixmatch, LRCLIB, LyricFind (via YouTube Music), and AMLL (a hand-curated, word-by-word lyrics database) — always picks the best match, no manual searching required
