...
| 灵动岛/刘海样式悬浮歌词 | 贴着刘海（或无刘海机型的居中兜底胶囊）的磨砂玻璃小窗：左侧歌名、右侧播放控制、逐字高亮歌词常显；鼠标悬停展开显示下一句预览+迷你进度条；与经典桌面悬浮窗各自独立开关，可以同时开 | `desktop-lyrics/UI/NotchLyrics*.swift` | 设置「外观」tab「悬浮窗」分区，「桌面悬浮歌词」「灵动岛歌词」各自的开关 |
