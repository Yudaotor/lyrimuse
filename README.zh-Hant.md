...
**Mac 上的桌面浮動歌詞：逐字同步、常駐最上層，也可以放進選單列、動態島膠囊或完整歌詞視窗——支援 Apple Music、QQ 音樂、網易雲音樂、酷狗音樂、汽水音樂、Spotify，以及瀏覽器裡的網頁版 YouTube Music / Spotify。外加 Last.fm 聆聽檔案和裝置端機器翻譯。**
...
Lyrimuse 常駐在選單列裡，跟著目前播放把浮動歌詞釘在螢幕上——Apple Music、QQ 音樂、網易雲音樂、酷狗音樂、汽水音樂、Spotify，以及瀏覽器裡的網頁版 YouTube Music / Spotify，任選幾個組合（也可以交給自動偵測）——像卡拉 OK 一樣逐字填色、常駐最上層、跨 Space 顯示。想低調一點，也可以只在選單列顯示目前這句歌詞，或者收進瀏海下的動態島膠囊。就是網易雲音樂桌面用戶端那種「桌面歌詞」體驗，只不過是原生 macOS 版本。
...
在設定裡打開桌面浮動歌詞就行。它浮在所有視窗之上、跨 Space 顯示，可以拖到任何位置，也可以釘在螢幕頂部置中，或 Dock 之上的底部置中；歌詞帶逐字時間軸時，唱到哪個字就填色到哪個字。螢幕快照、螢幕錄製、螢幕分享時可以讓它只有你自己看得見，暫停時還能自動收起。QQ 音樂、網易雲音樂、酷狗音樂、汽水音樂、Spotify 和網頁播放器也是一樣用。
