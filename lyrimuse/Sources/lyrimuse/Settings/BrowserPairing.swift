...
enum BrowserPairing {
    ...
    static func trustAndPair(
        ...
        Task {
            ...
            // 开关、给系统自动化授权)全藏在"点那个小图标"后面,没有任何指引。
    ...
    /// Opera / Chromium 各分支、以及被有意从默认名单里拿掉的 Arc)唯一的入口。
    ///
    /// 从 `SettingsView.chooseBrowserFromApplications` 下沉到这里:引导页
