...
public enum SpotifyArtworkURL {
    ...
    /// 解析 AppleScript 回来的字符串。不是 https / 主机不对 / 路径形状不对 到 nil
    ...
    /// 同一张图换档位。不是 Spotify 图床地址 到 nil(别把别家 URL 改坏)。
...
/// Spotify URI 到 能交给 LaunchServices 打开的深链(「在 Spotify 中显示」)。
///
...
/// 播客节目(`spotify:episode:`)同理放行;广告(`spotify:ad:`)、本地文件(`spotify:local:`)没有可跳的页 到 nil,
