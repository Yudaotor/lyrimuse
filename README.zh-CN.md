...
**跟着 Apple Music、QQ 音乐、网易云音乐、酷狗音乐或 Spotify 播放，在 Mac 桌面上实时显示逐字同步歌词——外加 Last.fm 听歌档案和端上机器翻译。**
...
### 歌词，做到位
- **逐字同步高亮**，跟随播放进度实时显示
- **自动查六个歌词源**——网易云音乐、QQ 音乐、酷狗、Musixmatch、LRCLIB、AMLL（人工校对过的逐字歌词库）——自动挑出最合适的一份，不用自己动手搜
