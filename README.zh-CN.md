...
### 歌词，做到位
- **逐字同步高亮**，跟随播放进度实时显示
- **自动查十一个歌词源**——网易云音乐、QQ 音乐、酷狗、酷我、咪咕、Musixmatch、LRCLIB、LyricFind（经 YouTube Music）、Deezer、AMLL（人工校对过的逐字歌词库）、Apple Music 官方歌词（可选，需在设置里连接账号；唯一的官方源，不少曲目还带逐字时间轴）——自动挑出最合适的一份，不用自己动手搜
